...
Window56::Window56(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Window56)
{
    ui->setupUi(this);
    ...
    // 以下是5.2.5节内容
    highlighter = new SyntaxHighlighter56(ui->textEdit->document());
...
// 设置字体格式
void Window56::setTextFont(bool checked)
{
    // 如果处于选中状态
    if(checked){
        QTextCursor cursor = ui->textEdit->textCursor();
