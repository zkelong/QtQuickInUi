#include "window54.h"
#include "ui_window54.h"
#include <QTextFrame>
#include <QDebug>


Window54::Window54(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Window54)
{
    ui->setupUi(this);
...
// 设置字体格式
void Window54::setTextFont(bool checked)
{
    // 如果处于选中状态
    if(checked){
        QTextCursor cursor = ui->textEdit->textCursor();
