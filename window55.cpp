...
#include <QPushButton>
#include <QVBoxLayout>
Window55::Window55(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Window55)
{
    ui->setupUi(this);
...
// 设置字体格式
void Window55::setTextFont(bool checked)
{
    // 如果处于选中状态
    if(checked){
        QTextCursor cursor = ui->textEdit->textCursor();
...
// 插入图片
void Window55::insertImage()
{
    // 图片格式
    QTextImageFormat format;
    // 图片路径
    format.setName(":res/logo.png");
    ui->textEdit->textCursor().insertImage(format);
}

// 查找文本
void Window55::textFind()
{
    // 创建对话框
