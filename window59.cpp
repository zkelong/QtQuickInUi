#include "window59.h"
#include "ui_window59.h"
#include <QtPrintSupport/QPrintDialog>
#include <QtPrintSupport/QPrintPreviewDialog>
#include <QFileDialog>
#include <QFileInfo>
Window59::Window59(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Window59)
{
    ui->setupUi(this);
...
void Window59::printPreview(QPrinter *printer)
{
    ui->textEdit->print(printer);
}

// 生成PDF文件
void Window59::createPdf()
{
