...
Dialog37::Dialog37(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialog37)
{
    ui->setupUi(this);
...
void Dialog37::on_pushButton_color_clicked()
{
    //指定默认颜色
    QColorDialog cdl(Qt::red, this);
    // 显示alpha选项
    cdl.setOption(QColorDialog::ShowAlphaChannel);
    // 以模态方式运行对话框
    cdl.exec();
    // 获取当前颜色
    QColor color = cdl.currentColor();
    // 输出颜色信息
    qDebug()<<"color:"<<color;
}

void Dialog37::on_pushButton_file_clicked()
{
...
void Dialog37::on_pushButton_font_clicked()
{
    // 标记是否按下了“OK”按钮
    bool ok;
    ...
    if(ok) ui->pushButton_font->setFont(font);
    else qDebug() <<tr("没有选择字体！");
}

void Dialog37::on_pushButton_input_clicked()
{
    bool ok;
    // 获取字符串
...
void Dialog37::on_pushButton_message_clicked()
{
    // 问题对话框
...
void Dialog37::on_pushButton_progress_clicked()
{
...
void Dialog37::on_pushButton_erromessage_clicked()
{
...
void Dialog37::on_pushButton_guide_clicked()
{
    QWizard wizard(this);
...
// 向导页面1
QWizardPage *Dialog37::createPage1()
{
...
// 向导页面2
QWizardPage *Dialog37::createPage2()
{
    QWizardPage *page = new QWizardPage;
...
// 向导页面3
QWizardPage *Dialog37::createPage3()
{
    QWizardPage *page = new QWizardPage;
    page->setTitle(tr("结束"));
    return page;
